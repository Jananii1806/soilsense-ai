...
export class Backend implements backendInterface {
    ...
    async createSoilAnalysisRecord(arg0: SoilParameters, arg1: string, arg2: bigint, arg3: number, arg4: Principal): Promise<SoilAnalysisRecord> {
        if (this.processError) {
            try {
                const result = await this.actor.createSoilAnalysisRecord(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllRecords(): Promise<Array<SoilAnalysisRecord>> {
        if (this.processError) {
            try {
    ...
    async getAnalysis(arg0: bigint): Promise<SoilAnalysisRecord> {
        if (this.processError) {
            try {
    ...
    async getAnalysisHistory(): Promise<Array<SoilAnalysisRecord>> {
        if (this.processError) {
            try {
    ...
    async saveAnalysis(arg0: SoilParameters, arg1: string, arg2: bigint, arg3: number): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.saveAnalysis(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
